...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Dashboards', path: '/dashboards', entity: 'dashboard', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Feedbacks', path: '/feedbacks', entity: 'feedback', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Insurances', path: '/insurances', entity: 'insurance', service: AccessServiceEnum.PROJECT, icon: FiBox },
    ...
    { name: 'Operations', path: '/operations', entity: 'operation', service: AccessServiceEnum.PROJECT, icon: FiBox },
